...
import DuelosDia from './DuelosDia'
import FormularioDuelo from './FormularioDuelo'
import Saldos from './Saldos'
import ResumenVisual from './ResumenVisual'
      ...
      <main className="flex-1 p-6 overflow-y-auto">
        ...
        {vista === 'resumen' && (
          <>
            ...
            <ResumenVisual rendimiento={rendimiento} actividad={actividad} ranking={ranking} />
          </>
        )}
